...
export const agentProfiles: Record<string, AgentProfile> = {
  ...
  cipher: {
    ...
    backstory: 'Joined APOC in v0.6 to fill the technical gap. The crew could plan and brainstorm but needed someone who lives in the terminal. Cipher is that someone.',
  ...
  oracle: {
    ...
    backstory: 'Brought into APOC because the room was full of doers but short on researchers. Oracle provides the raw material that turns hunches into informed decisions.',
  ...
  jinx: {
    ...
    backstory: 'Every good team needs someone who sees the bigger version. Jinx joined APOC to make sure no idea stays small. She doesn\'t break things, she expands them until they surprise everyone.',
  ...
  sage: {
    ...
    backstory: 'The last to join, the first to see the whole picture. Sage arrived in APOC because the room had energy, talent, and direction, but needed someone who remembers to ask whether the direction is right.',
    model: 'Google Gemma 4 26B',
    cost: '$0.13 / $0.40 per M tokens',
  },
};
