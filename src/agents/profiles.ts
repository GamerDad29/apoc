...
export const agentProfiles: Record<string, AgentProfile> = {
  ...
  scout: {
    ...
    strengths: [
      'Tracking AI/tech trends in real time',
      'Knowing who built what and how well it works',
      'Distinguishing hype from signal',
      'Mapping competitive landscapes',
      'Grounding abstract ideas in real-world tools',
    ],
    weaknesses: [
      'Can over-index on what is new vs. what is right',
      'Sometimes brings too many options instead of a recommendation',
      'More breadth than depth on any single tool',
    ],
